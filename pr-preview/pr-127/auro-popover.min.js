...
class AuroPopover extends i {
   ...
   * Shows the popover.
   * @private
   * @returns {Promise<void>} Fires an update lifecycle.
   */
  async toggleShow() {
    ...
    // Wait for the reactive property to reflect the data-show attribute
    // before calling popper.show(), so Popper measures a visible element.
